...
#ifndef SMARTENGINE_STORAGE_MINOR_COMPACTION_H_
#define SMARTENGINE_STORAGE_MINOR_COMPACTION_H_
...
//    const common::SeSchema *schema_;
  ...
  void clear_current_readers() override;
...
//      const SeSchema* src_schema, const SeSchema* dst_schema,
//      BlockInfo* out_block, util::WritableBuffer* buf);
