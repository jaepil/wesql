...
TEST(Serialize_x, multi_data_types)
{
  ...
  strcpy(obj.pod_type_.str_, "smartengine");
  obj.vector_type_.push_back(56);
  obj.vector_type_.push_back(78);
  obj.vector_type_.push_back(90);
  obj.autovector_type_.push_back(POD(12, 23, 34, 56, "smartengine"));
  obj.autovector_type_.push_back(POD(56, 34, 23, 12, "smartengine"));
...
TEST(Serialize_x, compactiple)
{
  ...
  strcpy(base_struct.pod_.str_, "smartengine");
