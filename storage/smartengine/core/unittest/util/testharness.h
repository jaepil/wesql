...
#define ASSERT_OK(s) ASSERT_PRED_FORMAT1(smartengine::util::test::AssertStatus, s)
#define ASSERT_NOK(s) ASSERT_FALSE((s).ok())
#define EXPECT_OK(s) EXPECT_PRED_FORMAT1(smartengine::util::test::AssertStatus, s)
