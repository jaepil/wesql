...
{
  std::string log_path = smartengine::util::test::TmpDir() + "/storage_common_test.log";
  smartengine::util::test::init_logger(log_path.c_str(), smartengine::logger::DEBUG_LEVEL);
