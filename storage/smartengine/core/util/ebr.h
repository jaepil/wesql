...
class EBRGaurd {
public:
  EBRGaurd() { smartengine::util::EBRManager::get_instance().enter_critical_area(); }
  ~EBRGaurd() { smartengine::util::EBRManager::get_instance().leave_critical_area(); }
};

} // namespace util
} // namespace smartengine

#define EBRMANAGER (smartengine::util::EBRManager::get_instance())
