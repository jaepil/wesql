...
#ifndef SMARTENGINE_INCLUDE_TEMPLATE_UTIL_H_
#define SMARTENGINE_INCLUDE_TEMPLATE_UTIL_H_
#include <vector>
#include <list>
...
#define HAS_MEMBER(type, member) smartengine::util::has_##member<type>::value

#define IS_CONTAINER(type) ((smartengine::util::is_container<type>::value) || (smartengine::util::is_kv_container<type, void>::value))
  
#endif //SMARTENGINE_INCLUDE_TEMPLATE_UTIL_H_  
