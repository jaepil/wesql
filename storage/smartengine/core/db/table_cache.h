...
public:
 ...
 int find_table_reader(const InternalKeyComparator &internal_key_comparator,
                       const storage::ExtentId &extent_id,
                       const bool no_io,
 ...
 table::TableReader* get_table_reader_from_handle(cache::Cache::Handle* handle);
...
private:
 ...
 int create_table_reader(const InternalKeyComparator& internal_comparator,
                         const storage::ExtentId &extent_id,
                         bool skip_filters,
                         int level,
