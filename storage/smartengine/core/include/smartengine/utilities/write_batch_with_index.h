...
#include "smartengine/write_batch_base.h"
...
class WriteBatchWithIndex : public db::WriteBatchBase {
 public:
  ...
  using smartengine::db::WriteBatchBase::SingleDelete;
  ...
  using smartengine::db::WriteBatchBase::Clear;
  void Clear() override;

  using smartengine::db::WriteBatchBase::GetWriteBatch;
