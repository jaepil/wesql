...
FUNCTION(BUILD_MYSQL_BUNDLED_LZ4 LZ4_ROOT DEST)
  INCLUDE_DIRECTORIES(BEFORE SYSTEM ${LZ4_ROOT})
  SET(LZ4_HDRS
    ${LZ4_ROOT}/lz4file.h
    ${LZ4_ROOT}/lz4frame.h
    ${LZ4_ROOT}/lz4frame_static.h/
    ${LZ4_ROOT}/lz4.h
    ${LZ4_ROOT}/lz4hc.h
    ${LZ4_ROOT}/xxhash.h)
  ...
  ADD_CONVENIENCE_LIBRARY(lz4 ${LZ4_HDRS} ${LZ4_SRCS} COMPILE_OPTIONS "-fPIC")
ENDFUNCTION()
