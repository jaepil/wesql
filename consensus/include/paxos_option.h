...
class DefaultExtraStore : public ExtraStore {
  virtual std::string getRemote() override { return ""; }
  virtual void setRemote(const std::string&) override {}
  /* local info to send to others */
  virtual std::string getLocal() override { return ""; }
};
