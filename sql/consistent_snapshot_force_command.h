...
class Consistent_archive_force_command : public Udf_service_impl {
 public:
  Consistent_archive_force_command() = default;
  ~Consistent_archive_force_command() override = default;
  bool init() override;
  bool deinit();
 ...
 private:
  ...
  static char *consistent_archive_force(UDF_INIT *, UDF_ARGS *args, char *result,
                    ...
                    unsigned char *error);
  static bool consistent_archive_force_init(UDF_INIT *init_id, UDF_ARGS *args, char *message);
  static void consistent_archive_force_deinit(UDF_INIT *);
};
#endif
