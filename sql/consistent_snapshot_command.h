...
#ifndef CONSISTENT_SNAPSHOT_COMMAND_INCLUDED
#define CONSISTENT_SNAPSHOT_COMMAND_INCLUDED

#include "sql/udf_service_impl.h"
#include "sql/udf_service_util.h"

class Consistent_archive_command : public Udf_service_impl {
 public:
  Consistent_archive_command() = default;
  ~Consistent_archive_command() override = default;
  bool init() override;
  bool deinit();
