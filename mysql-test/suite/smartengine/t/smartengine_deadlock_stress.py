...
Usage: smartengine_deadlock_stress.py user host port db_name table_name
...
if __name__ == '__main__':
  if len(sys.argv) != 8:
    print ("Usage: smartengine_deadlock_stress.py user host port db_name table_name num_iters num_threads")
    sys.exit(1)
