...
#define easy_log(format, args...) \
        easy_log_format(EASY_LOG_OFF, __FILE__, __LINE__, __FUNCTION__, format, ## args)
...
#else
#define EASY_PRINT_BT(format, args...) easy_debug_log(format, args...)
#endif
